...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        >
            <h6 class="m-0 font-weight-bold text-primary">Daftar Rute Hauling</h6>
        </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Tombol edit -->
                                <a href="{{ route('dashboard.tracks.edit', $track->id) }}" 
                                class="btn btn-sm btn-warning">
                                    <i class="fas fa-edit"></i>
                                </a>

                                <!-- Tombol delete -->
                                <form action="{{ route('dashboard.tracks.destroy', $track->id) }}" 
                        ...
                        @empty
                        <tr>
                            <td colspan="9" class="text-center">Belum ada rute ditambahkan</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
