...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        class="btn btn-primary btn-icon-split">
            ...
            <span class="text">Tambah Lokasi Kerja</span>
        </a>
    ...
    <div class="card shadow mb-4">
        ...
        >
            <h6 class="m-0 font-weight-bold text-primary">Daftar Lokasi Kerja</h6>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- Tombol delete -->
                                <form action="{{ route('dashboard.locations.destroy', $location->id) }}" 
                        ...
                        @empty
                        <tr>
                            <td colspan="8" class="text-center">Belum ada lokasi kerja ditambahkan</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
