                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Tombol Restore -->
                                <form action="{{ route('dashboard.partners-trash.restore', $partner->id) }}" 
                                ...
                                <!-- Tombol delete -->
                                <form action="{{ route('dashboard.partners-trash.force-delete', $partner->id) }}" 
                                    method="POST" style="display:inline">
                                    @csrf
                                    @method('DELETE')
                        ...
                        @empty
                        <tr>
                            <td colspan="9" class="text-center">Belum ada mitra yang dihapus</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
