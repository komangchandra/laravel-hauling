        ...
        <div class="card-body">
            ...
            <form action="{{ route('dashboard.manpowers.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="photo_path" class="form-label font-weight-bold">Foto</label>
                        ...
                        @error('photo_path')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <img id="photoPreview" class="img-thumbnail mt-2" style="max-width:200px; display: none;" alt="Preview Photo">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label for="document_path" class="form-label font-weight-bold">Dokumen</label>
                        <input class="form-control{{ $errors->has('document_path') ? ' is-invalid' : '' }}" type="file" id="document_path" name="document_path" accept=".pdf,.doc,.docx" onchange="previewDocument(event)">
                        @error('document_path')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
