...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('dashboard.manpowers.create') }}"
        class="btn btn-primary btn-icon-split">
            <span class="icon text-white-50">
                <i class="fas fa-plus fa-sm text-white-50"></i>
            </span>
            <span class="text">Form Pengajuan Man Power</span>
        </a>
    ...
    <div class="card shadow mb-4">
        ...
        >
            <h6 class="m-0 font-weight-bold text-primary">Daftar Man Power</h6>
        </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $manpower->partner->legal_name ?? 'N/A' }}</td>
                            <td>{{ $manpower->valid_until ? \Carbon\Carbon::parse($manpower->valid_until)->format('d-m-Y') : 'N/A' }}</td>
                            <td>
                                ...
                                @elseif ($manpower->status == 'tidak_aktif')
                                    <span class="badge badge-danger">Tidak Active</span>
                            ...
                            <td>
                                <!-- Tombol Tinjau -->
                                <a href="{{ route('dashboard.manpowers.show', $manpower->id) }}" 
                                class="btn btn-sm btn-info">
                                    <i class="fas fa-eye"></i>
                                </a>
                                {{-- <!-- Tombol edit -->
                                <a href="{{ route('dashboard.manpowers.edit', $manpower->id) }}" 
                                class="btn btn-sm btn-warning">
                                    <i class="fas fa-edit"></i>
                                </a> --}}

                                <!-- Tombol delete -->
                                <form action="{{ route('dashboard.manpowers.destroy', $manpower->id) }}" 
                        ...
                        @empty
                        <tr>
                            <td colspan="8" class="text-center">Belum ada man power ditambahkan</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
