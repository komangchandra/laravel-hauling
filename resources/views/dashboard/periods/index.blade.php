...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('dashboard.periods.create') }}"
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Tombol edit -->
                                <a href="{{ route('dashboard.periods.edit', $period->id) }}" 
                                class="btn btn-sm btn-warning">
                                    <i class="fas fa-edit"></i>
                                </a>

                                <!-- Tombol delete -->
                                <form action="{{ route('dashboard.periods.destroy', $period->id) }}" 
                        ...
                        @empty
                        <tr>
                            <td colspan="8" class="text-center">Belum ada periode ditambahkan</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
